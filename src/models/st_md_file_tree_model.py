...
class STMDFileTreeModel(QAbstractItemModel):
    ...
    def add_file(self, file_path: str, parsed_data: dict):
        ...
        # 4. Старый добрый _build_tree строит поддерево из structure.
        ...
        # 5. Добавляем корневой элемент файла в корень всей модели.
        self.root_item.appendChild(file_item)

        self.layoutChanged.emit()   # Уведомляем класс, где отображается модель
