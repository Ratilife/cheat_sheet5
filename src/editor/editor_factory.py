...
class EditorFactory:
    ...
    def get_supported_extensions() -> List[str]:
        ...
        практические ситуации для метода:
             Фильтрация файлов в диалогах открытия/сохранения
             Валидация файлов при перетаскивании (Drag & Drop)
             Динамическое создание фильтров для файлового браузера
             Проверка возможности открытия файла
             Генерация документации/справки
        """
        # TODO 04.10.2025 мертвый код метод get_supported_extensions
    ...
    def get_editor_description(extension: str) -> str:
        ...
        практические ситуации для метода:
            ...
            Диалог "О программе" или справка
            Контекстное меню файлового браузера
            Заголовки вкладок редактора
            Логирование и отладка
            Экспорт/импорт диалоги
            Статистика и аналитика
        """
        # TODO 04.10.2025 мертвый код метод get_editor_description
    ...
    def register_editor(extension: str, editor_class: Type[BaseFileEditor]) -> None:
        ...
        практические ситуации для метода:
           ...
           Тестирование
           Условная регистрация редакторов - Регистрация редакторов в зависимости от условий
           Переопределение редакторов по умолчанию - Пользователь может выбрать свой редактор для формата
           Регистрация редакторов для новых форматов
           Миграция редакторов - Плавный переход на новую версию редактора
        """
        # TODO 04.10.2025 мертвый код метод register_editor
    ...
    def unregister_editor(extension: str) -> None:
        ...
        """
        # TODO 04.10.2025 мертвый код метод unregister_editor
